		...
		_findBackgrounds: function () {
			...
			(s = this.$element.find('[data-stellar-background-ratio]')),
				...
				s.each(function () {
					...
					s.data('stellar-backgroundStartingLeft') ? c(s, s.data('stellar-backgroundStartingLeft'), s.data('stellar-backgroundStartingTop')) : (s.data('stellar-backgroundStartingLeft', o[0]), s.data('stellar-backgroundStartingTop', o[1])),
