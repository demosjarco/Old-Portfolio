...
(function ($) {
	...
	function SimpleExpand() {
		var that = this;
		that.defaults = { hideMode: 'fadeToggle', defaultSearchMode: 'parent', defaultTarget: '.content', throwOnMissingTarget: true, keepStateInCookie: false, cookieName: 'simple-expand' };
		that.settings = {};
